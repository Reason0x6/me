...
export class ScriptsComponent{
  ...
  cards: Card[] = [
    ...
    { title: 'Recursive File & Content Search Script', description: "A Bash script that recursively searches a directory for files with names containing a given term or files that include the term in their content.",  link: '/scripts/search_term.sh'},
